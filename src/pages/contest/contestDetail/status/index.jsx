...
import { Table, Row, Col, Input, Form, Button, Select } from 'antd';
...
const StatusList = (props) => {
  const {
    ...
    contestDetail: { statusList, statusTotal },
  } = props;
...
export default connect(({ contestDetail, loading }) => ({
  contestDetail,
  fetchStatusListLoading: loading.effects['contestDetail/fetchStatusList'],
}))(StatusList);
